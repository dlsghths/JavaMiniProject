...
public class PanelPurchaseListItem {
	...
	public PanelPurchaseListItem(JPanel panelList, JPanel parentPanel, ArrayList<PurchaseHistory> purchaseList, CardLayout cardLayout) {
